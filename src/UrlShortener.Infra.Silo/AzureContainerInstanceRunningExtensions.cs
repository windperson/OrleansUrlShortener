...
{
    public static class AzureContainerInstanceRunningExtensions
    {
    public static ISiloBuilder UseAzureContainerInstanceRunningConfiguration(this ISiloBuilder siloBuilder,
