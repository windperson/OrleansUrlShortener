...
resource az_container_registy 'Microsoft.ContainerRegistry/registries@2022-02-01-preview' = {
  name: acrName
  location: location
  sku: {
    name: acrSku
...
// image push webhook
resource pushWebhook 'Microsoft.ContainerRegistry/registries/webhooks@2022-02-01-preview' = [for webhook in webhookUrls: {
  name: '${webhook.name}'
